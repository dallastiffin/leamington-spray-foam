/**
 * Leamington Spray Foam Insulation — website lead handler
 * =====================================================
 *
 ...
 */
function doGet() {
  return reply(true, 'Leamington Spray Foam Insulation lead endpoint is running.');
}
...
function sendAlert(data) {
  ...
  MailApp.sendEmail({
    to: NOTIFY_EMAIL,
    subject: 'New estimate request: ' + (data.service || 'Leamington Spray Foam Insulation'),
    body: lines.join('\n'),
